export const CsharpIcon = ()=> {
    return(
        ...
        baseProfile="basic">
        <linearGradient id="dFMIpH0DLBLP_Mye2ctJMa" x1="15.25" x2="15.25"
        ...
        <path fill="url(#dFMIpH0DLBLP_Mye2ctJMa)"
            d="M19.09,39.37c0,0.01,0.01,0.01,0.01,0.02l-7.7,4.5L19.09,39.37z" />
        <linearGradient id="dFMIpH0DLBLP_Mye2ctJMb" x1="15.25" x2="15.25"
            y1="33.329" y2="20.11" gradientTransform="matrix(1 0 0 -1 0 64)"
            gradientUnits="userSpaceOnUse">
            <stop offset="0" stopColor="#8ab4ff" />
            <stop offset=".699" stopColor="#e492ff" />
        </linearGradient>
        <path fill="url(#dFMIpH0DLBLP_Mye2ctJMb)"
            d="M19.09,39.37c0,0.01,0.01,0.01,0.01,0.02	l-7.7,4.5L19.09,39.37z" />
        <linearGradient id="dFMIpH0DLBLP_Mye2ctJMc" x1="31.87" x2="31.87"
            y1="10.7" y2="35.152" gradientUnits="userSpaceOnUse">
            <stop offset="0" stopColor="#8ab4ff" />
            <stop offset="1" stopColor="#e492ff" />
        </linearGradient>
        <path fill="url(#dFMIpH0DLBLP_Mye2ctJMc)"
